...
class RoomForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ["name", "capacity", "facilities", "building", "floor", "departments", "color", "calendar_url"]
        labels = {
            "name": "室名",
            "capacity": "収容人数",
            "building": "建物",
        ...
        widgets = {
            ...
            "calendar_url": forms.URLInput(attrs={"placeholder": "https://calendar.google.com/..."}),
        }
